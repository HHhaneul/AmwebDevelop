...
import static org.mockito.BDDMockito.*;
    ...
    void requiredFieldTest() {
        ...
        assertAll(
                () -> { // userId 필수 검증
                    ...
                    requiredTestEach(member, "아이디를 입력하세요.");
                ...
                () -> { // userPw 필수 검증
                    ...
                    requiredTestEach(member, "비밀번호를 입력하세요.");
                ...
                () -> { // userPwRe 필수 검증
                    ...
                    requiredTestEach(member, "비밀번호가 같지 않습니다.");
                ...
                () -> { // userNm 필수 검증
                    ...
                    requiredTestEach(member, "회원명을 입력하세요.");
                ...
                () -> { // agree 필수 검증
                    ...
                    requiredTestEach(member, "회원가입 약관에 동의하세요.");
                }
        );
    }
    ...
    void userPwCorrectCheckTest() {
        ...
        requiredTestEach(member, "비밀번호가 일치하지 않습니다.");
    }
